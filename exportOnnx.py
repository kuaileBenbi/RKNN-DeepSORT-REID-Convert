...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_deepsort",
        type=str,
        default="deep_sort.yaml",
        help="Configure tracker",
    )
    parser.add_argument(
        "--cpu", dest="use_cuda", action="store_false", default=True, help="Run in CPU"
    )
    ...
    # torch.onnx.export(model.extractor.net.cuda(), input_tensor, output_onnx, export_params=True, verbose=True,
